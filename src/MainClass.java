...
public class Main_class {
	...
	public static void create(BufferedReader br, Connection conn)
	{
		try {
	...
	public static void retrieve(BufferedReader br, Connection conn)
	{
		try {
	...
	public static void update(BufferedReader br, Connection conn)
	{
		try {
	...
	public static void delete(BufferedReader br, Connection conn)
	{
		try {
